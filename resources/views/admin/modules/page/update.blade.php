                        ...
                        <div class="row">
                            <div class="col-12">
                                <div
                                    ...
                                    {{ Form::textarea('content', (count($page->availableLanguage) > 0) ? $page->availableLanguage[0]->content : '', ['id'=>'ckeditor1','class' => 'form-control', 'no','placeholder'=>__('admin.enter_content')]) }}
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div
                                    ...
                                    {{ Form::textarea('content_2', (count($page->availableLanguage) > 0) ? $page->availableLanguage[0]->content_2 : '', ['id'=>'ckeditor2','class' => 'form-control', 'no','placeholder'=>__('admin.enter_content').' 2']) }}
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div
                                    ...
                                    {{ Form::textarea('content_3', (count($page->availableLanguage) > 0) ? $page->availableLanguage[0]->content_3 : '', ['id'=>'ckeditor3','class' => 'form-control', 'no','placeholder'=>__('admin.enter_content').' 3']) }}
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div
                                    ...
                                    {{ Form::textarea('content_4', (count($page->availableLanguage) > 0) ? $page->availableLanguage[0]->content_4 : '', ['id'=>'ckeditor4','class' => 'form-control', 'no','placeholder'=>__('admin.enter_content').' 4']) }}
